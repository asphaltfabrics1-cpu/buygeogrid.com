...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://www.buygeogrid.com/nonwoven-fabrics',
  },
  openGraph: {
    title: 'Nonwoven Geotextile Ohio | Mirafi 135N 180N',
    description: 'Solmax Mirafi nonwoven geotextile distributor in Northern Ohio. 135N, 140N, 180N for drainage, filtration and separation. Cleveland, Akron, Toledo.',
    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-grow">
        ...
        <section className="py-20 md:py-24 px-6 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            <Reveal className="mb-8">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 leading-tight tracking-tight text-center">Browse Nonwoven Geotextile Products</h2>
            </Reveal>
        ...
        <section className="py-20 md:py-24 px-6 bg-white">
          <div className="max-w-4xl mx-auto">
            <Reveal>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight tracking-tight text-center">What Are Nonwoven Geotextiles?</h2>
        ...
        <section className="py-20 md:py-24 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <Reveal>
              <div className="text-[#00c97e] text-xs md:text-sm font-semibold uppercase tracking-[0.2em] mb-3 text-center">Functions</div>
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight tracking-tight text-center">Primary Functions</h2>
        ...
        <section className="py-20 md:py-24 px-6 bg-white">
          <div className="max-w-4xl mx-auto">
            <Reveal>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight tracking-tight text-center">Common Applications</h2>
        ...
        <section className="py-20 md:py-24 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <Reveal>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight tracking-tight text-center">Benefits and Durability</h2>
              <p className="text-lg text-gray-700 leading-relaxed">
        ...
        <section className="py-20 md:py-24 px-6 bg-white">
          <div className="max-w-4xl mx-auto">
            <Reveal>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight tracking-tight text-center">Choosing the Right Product</h2>
              <p className="text-lg text-gray-700 leading-relaxed">
