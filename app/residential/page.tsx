    ...
    <div className="min-h-screen flex flex-col bg-white">
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 px-6 bg-white">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">The soft-clay driveway problem</h2>
        ...
        <section className="py-16 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Partial rolls — sized for residential jobs</h2>
        ...
        <section className="py-16 px-6 bg-white">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Where residential geogrid pays off</h2>
        ...
        <section className="py-16 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="space-y-6">
              {faqs.map((f) => (
                <div key={f.q} className="bg-white border border-gray-200 rounded p-6">
        ...
        {/* Quote form */}
        <section id="quote" className="py-16 px-6 bg-white scroll-mt-20">
          <div className="max-w-2xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-2">Get a same-day quote</h2>
            <p className="text-lg text-gray-700 mb-6">
