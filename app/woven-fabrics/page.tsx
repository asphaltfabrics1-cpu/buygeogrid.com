...
export const metadata: Metadata = {
  ...
  description: 'Solmax Mirafi woven geotextile distributor in Northern Ohio. 500X, 600X for soil stabilization, separation and reinforcement. Cleveland, Akron, Toledo.',
  ...
  alternates: {
    canonical: 'https://www.buygeogrid.com/woven-fabrics',
  },
  openGraph: {
    title: 'Woven Geotextile Ohio | Mirafi 500X 600X',
    description: 'Solmax Mirafi woven geotextile distributor in Northern Ohio. 500X, 600X for soil stabilization, separation and reinforcement. Cleveland, Akron, Toledo.',
        ...
        <section className="py-20 md:py-24 px-6 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            <Reveal className="mb-8">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 leading-tight tracking-tight text-center">Browse Woven Geotextile Products</h2>
            </Reveal>
        ...
        <section className="py-20 md:py-24 px-6 bg-white">
          <div className="max-w-4xl mx-auto">
            <Reveal>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight tracking-tight text-center">What Are Woven Geotextiles?</h2>
        ...
        <section className="py-20 md:py-24 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <Reveal>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight tracking-tight text-center">How Woven Geotextiles Work</h2>
        ...
        <section className="py-20 md:py-24 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <Reveal>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight tracking-tight text-center">Environmental Benefits</h2>
              <p className="text-lg text-gray-700 leading-relaxed">
