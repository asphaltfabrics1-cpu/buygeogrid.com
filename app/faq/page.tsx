...
export default function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      answer: 'An interlayer is a specialty paving fabric installed between layers of asphalt to prevent cracking and moisture penetration. It acts as a moisture barrier and stress-relief layer, extending the life of pavements and reducing reflective cracking.',
    },
    {
