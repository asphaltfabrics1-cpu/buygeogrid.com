...
export const metadata: Metadata = {
  ...
  description: 'Muddy driveway in Cleveland, Lakewood, Parma, or the East Side? The problem is our heavy clay soil pumping up through your gravel. Geogrid + geotextile stops it. Local pickup from Solon, OH.',
  keywords: ['muddy driveway Cleveland', 'gravel driveway Cleveland Ohio', 'muddy driveway Lakewood', 'driveway repair Parma', 'clay soil driveway Ohio', 'Cleveland driveway stabilization', 'East Side driveway mud'],
      ...
      <main className="flex-grow">
        ...
        <section className="py-16 px-6 bg-white">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">The Cleveland Clay Problem</h2>
        ...
        <section className="py-16 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Where We Deliver</h2>
        ...
        <section className="py-16 px-6 bg-white">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">The Fix, Applied to Cleveland Soil</h2>
        ...
        <section className="py-16 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-8">Cleveland FAQ</h2>
