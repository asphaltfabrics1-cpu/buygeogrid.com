        ...
        <section className="py-20 md:py-24 px-6 bg-gray-50">
          <div className="max-w-7xl mx-auto">
            <Reveal className="mb-8">
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 leading-tight tracking-tight text-center">Browse Paving Interlayer Products</h2>
            </Reveal>
        ...
        <section className="py-20 md:py-24 px-6 bg-white">
          <div className="max-w-4xl mx-auto">
            <Reveal>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight tracking-tight text-center">Applications</h2>
        ...
        <section className="py-20 md:py-24 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto">
            <Reveal>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight tracking-tight text-center">Why Treat Cracks?</h2>
              <p className="text-lg text-gray-700 leading-relaxed">
        ...
        <section className="py-20 md:py-24 px-6 bg-white">
          <div className="max-w-4xl mx-auto">
            <Reveal>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight tracking-tight text-center">Benefits</h2>
              <p className="text-lg text-gray-700 leading-relaxed">
