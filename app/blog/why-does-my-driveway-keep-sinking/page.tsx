      ...
      <main className="flex-grow">
        ...
        <section className="py-16 px-6 bg-white">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">The Physics of Sinking</h2>
        ...
        <section className="py-16 px-6 bg-gray-50">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">The Three Reasons Driveways Sink</h2>
        ...
        <section className="py-16 px-6 bg-white">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Why More Gravel Doesn&apos;t Fix It</h2>
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
        ...
        <section className="py-16 px-6 bg-gray-50">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">What Actually Stops the Sinking</h2>
        ...
        <section className="py-16 px-6 bg-[#1a1a1a] text-white">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Stop Buying the Same Gravel Every Year</h2>
            <p className="text-lg text-gray-300 mb-6">One weekend of installing geogrid + geotextile pays for itself in avoided re-gravelling within a season or two.</p>
