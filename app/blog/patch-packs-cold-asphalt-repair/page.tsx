      ...
      <main className="flex-grow">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded border border-gray-200 p-8">
              <div className="prose prose-lg max-w-none">
                ...
                <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-4 leading-tight tracking-tight">How Cold Asphalt Patch Works</h2>
                <p className="text-gray-700 mb-4 leading-relaxed">
                ...
                <div className="text-[#00c97e] text-xs md:text-sm font-semibold uppercase tracking-[0.2em] mb-3 mt-8">Variants</div>
                <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-4 leading-tight tracking-tight">Standard vs Flex Variants</h2>
                <p className="text-gray-700 mb-4 leading-relaxed">
                ...
                <div className="text-[#00c97e] text-xs md:text-sm font-semibold uppercase tracking-[0.2em] mb-3 mt-8">Application</div>
                <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-4 leading-tight tracking-tight">How to Apply Patch Packs</h2>
                <p className="text-gray-700 mb-4 leading-relaxed">
                ...
                <div className="text-[#00c97e] text-xs md:text-sm font-semibold uppercase tracking-[0.2em] mb-3 mt-8">Uses</div>
                <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-4 leading-tight tracking-tight">Applications</h2>
                ...
                <div className="text-[#00c97e] text-xs md:text-sm font-semibold uppercase tracking-[0.2em] mb-3 mt-8">Ohio</div>
                <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-4 leading-tight tracking-tight">Why It Matters in Ohio</h2>
                <p className="text-gray-700 mb-4 leading-relaxed">
                ...
                <div className="text-[#00c97e] text-xs md:text-sm font-semibold uppercase tracking-[0.2em] mb-3 mt-8">Specs</div>
                <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-4 leading-tight tracking-tight">Key Specifications</h2>
                <ul className="list-disc pl-6 mb-6 space-y-2 text-gray-700">
        ...
        <section className="py-20 md:py-24 px-6 bg-white">
          <div className="max-w-4xl mx-auto">
            <Reveal>
              ...
              <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-8 text-center leading-tight tracking-tight">Patch Packs FAQ</h2>
        ...
        <section className="py-20 md:py-24 px-6 bg-gray-50">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <h2 className="text-2xl md:text-4xl font-bold text-gray-900 mb-6 leading-tight tracking-tight">Related</h2>
