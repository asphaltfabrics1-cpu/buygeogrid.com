      ...
      <main className="flex-grow">
        ...
        <section className="py-16 px-6 bg-white">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">Why We Used to Excavate Everything</h2>
        ...
        <section className="py-16 px-6 bg-gray-50">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">The Mechanical Stabilization Alternative</h2>
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
        ...
        <section className="py-16 px-6 bg-white">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">When It Works and When You Still Excavate</h2>
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
        ...
        <section className="py-16 px-6 bg-gray-50">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">The Two-Layer Version for Very Soft Ground</h2>
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
        ...
        <section className="py-16 px-6 bg-white">
          <div className="max-w-3xl mx-auto">
            <h2 className="text-3xl font-bold text-gray-900 mb-6">The Design Isn&apos;t a Guess</h2>
            <p className="text-lg text-gray-700 leading-relaxed mb-4">
        ...
        <section className="py-16 px-6 bg-[#1a1a1a] text-white">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Free DCP + Free Design Support</h2>
            <p className="text-lg text-gray-300 mb-6">We come out, take DCP readings, and Tensar&apos;s engineers spec the design. No cost. Northern Ohio.</p>
